...
final class MercadoPagoPixService
{
    public function create(int $orderId,string $taxId='',?int $amountCents=null):array
    {
        ...
        // Resolve and validate provider-required payer data BEFORE creating a local
        // payment or holding stock. Invalid configuration must leave no orphaned
        // "created" payment and no unnecessary stock reservation behind.

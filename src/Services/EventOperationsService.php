...
final class EventOperationsService
{
    public function overview(): array
    {
        ...
        $sql='SELECT e.id,e.name,e.slug,e.venue,e.address,e.starts_at,e.ends_at,e.status,
            ...
            (SELECT COALESCE(SUM(o.total_cents),0) FROM orders o WHERE o.tenant_id=e.tenant_id AND o.event_id=e.id AND o.channel IN ("bar","event_bar") AND o.payment_status="paid") bar_revenue_cents

...
$CacheDir = Join-Path $env:USERPROFILE ".eventmenu-go"
...
if (-not (Test-Path "local.properties")) {
    ...
    if ($Sdk) {
        ...
        Write-Warning "SDK Android não localizado. Abra mobile/eventmenu-go no Android Studio ou defina ANDROID_SDK_ROOT."
    }
}

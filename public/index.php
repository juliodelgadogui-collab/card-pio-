...
// QR de retirada pode ser lido pela câmera normal. Guardamos somente este destino conhecido
// para retornar após o login, sem aceitar URL arbitrária ou redirecionamento externo.
...
if($route==='login'){
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
        ...
        elseif(Auth::attempt((string)($_POST['email']??''),(string)($_POST['password']??''))){
            ...
            app_redirect(Auth::isSuperAdmin()?'?route=super':'');
        }

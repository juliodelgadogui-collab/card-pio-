...
$checks=[
    ...
    'Retirada parcial legado'=>['app/routes/fulfillment_core.php',['Comprado:','Retirado:','Saldo:','Confirmar retirada','Vendas com saldo para retirar']],
    ...
    'Checkout legado'=>['public/pedido.php',['Finalizar Pedido','Forma de Pagamento','Taxa de Entrega','Endereço de Entrega','Alterar','Confirmação','checkout-stepper']],
    'Financeiro legado'=>['app/routes/finance_hub.php',['Recebido hoje','Recebido no mês','Vendas pagas no mês','Pagamentos pendentes','Últimos recebimentos','Caixa','Relatórios financeiros']],

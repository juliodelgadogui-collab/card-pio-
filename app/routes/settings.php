...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    try{
        ...
        Auth::audit('tenant.settings','tenant',(string)$tenantId,['delivery_paused'=>(bool)$settings['delivery_paused'],'timezone'=>$timezone]);

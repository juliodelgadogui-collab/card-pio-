...
import br.com.eventmenu.delivery.ui.DelyvreStage2Root

class MainActivity : ComponentActivity() {
    private val viewModel: DeliveryViewModel by viewModels()
    override fun onCreate(savedInstanceState: Bundle?) { super.onCreate(savedInstanceState);enableEdgeToEdge();handleIntent(intent);requestNotificationPermissionWhenNeeded();setContent{DelyvreStage2Root(viewModel)} }

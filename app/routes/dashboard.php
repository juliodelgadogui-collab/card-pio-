...
?><section class="grid"><div class="card metric"><span class="muted">Pedidos hoje</span><strong><?= (int)$stats['orders'] ?></strong></div><div class="card metric"><span class="muted">Recebido hoje</span><strong><?= em_money($stats['sales']) ?></strong></div><div class="card metric"><span class="muted">Comandas abertas</span><strong><?= (int)$stats['open_tabs'] ?></strong></div><div class="card metric"><span class="muted">Ingressos pagos</span><strong><?= (int)$stats['tickets'] ?></strong></div></section><section class="card" style="margin-top:18px"><div class="section-head"><h2>Pedidos recentes</h2><a class="button secondary" href="/?route=orders">Ver operação</a></div><div class="table-wrap"><table class="table"><thead><tr><th>#</th><th>Canal</th><th>Status</th><th>Pagamento</th><th>Total</th><th>Data</th></tr></thead><tbody><?php foreach($recent as $o):?><tr><td>#<?= (int)$o['id'] ?></td><td><?= Security::e($o['channel']) ?></td><td><span class="badge"><?= Security::e($o['status']) ?></span></td><td><?= Security::e($o['payment_status']) ?></td><td><?= em_money($o['total_cents']) ?></td><td><?= Security::e($o['created_at']) ?></td></tr><?php endforeach;?></tbody></table></div></section><section class="grid" style="margin-top:18px"><a class="card" href="/cardapio.php?loja=<?= urlencode((string)$pdo->query('SELECT slug FROM tenants WHERE id='.(int)$tenantId)->fetchColumn()) ?>"><h2>Cardápio público</h2><p class="muted">Visualizar experiência do cliente.</p></a><a class="card" href="/?route=tickets"><h2>Check-in</h2><p class="muted">Validar ingresso por código ou QR.</p></a><a class="card" href="/?route=restaurant"><h2>Salão</h2><p class="muted">Mesas e comandas abertas.</p></a></section><?php em_footer();

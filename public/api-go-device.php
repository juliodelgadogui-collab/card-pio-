...
try{
    ...
    if($action==='request-nfc'&&$_SERVER['REQUEST_METHOD']==='POST')god_out(['ok'=>true,'device'=>$service->requestNfcAuthorization($deviceId,(int)$user['token_id']),'message'=>'Solicitação enviada. O administrador pode autorizar este aparelho sem reinstalar o app.']);

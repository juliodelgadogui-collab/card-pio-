...
try{
    $checkouts=(new CheckoutReconciliationService())->reconcileExpired(50);
    $maintenance=(new MaintenanceService())->releaseExpiredReservations();
    $refunds=(new RefundService())->reconcileProcessing(50);
    $mail=(new MailQueueService())->process(50);
    $result=['checkouts'=>$checkouts,'reservations'=>$maintenance,'refunds'=>$refunds,'mail'=>$mail];

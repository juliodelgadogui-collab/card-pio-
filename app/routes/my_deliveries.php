...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    try{
        ...
        $s=$pdo->prepare('SELECT id,status,payment_status FROM orders WHERE id=? AND tenant_id=? AND channel="delivery" AND assigned_delivery_user_id=?');

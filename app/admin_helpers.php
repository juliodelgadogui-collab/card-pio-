...
function em_nav():array{return[['super','Super ADM','platform.manage'],['dashboard','Visão geral','dashboard'],['pos','Caixa / PDV','orders.create'],['kitchen','Cozinha / KDS','orders.kitchen'],['delivery','Entregas','orders.delivery'],['products','Cardápio','catalog.manage'],['orders','Pedidos','orders.view'],['restaurant','Mesas e comandas','tables.manage'],['customers','Clientes e pontos','customers.manage'],['coupons','Cupons','coupons.manage'],['events','Eventos','events.manage'],['tickets','Ingressos / Check-in','tickets.manage'],['guests','Convidados','guests.manage'],['promoters','Promotores','promoters.manage'],['payments','Pagamentos','payments.manage'],['gateways','Gateways e NFC','gateways.manage'],['users','Equipe','users.manage'],['reports','Relatórios','reports.any'],['audit','Auditoria','audit.view'],['settings','Configurações','settings.manage']];}
